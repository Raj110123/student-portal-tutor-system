...
const Hero = () => {
  return (
    <section className="min-h-[90vh] flex  flex-col items-center px-8 justify-center relative">
      ...
      <div className="arrow-div mt-16 sm:mt-22 bg-[var(--theme-color)] rounded-full absolute cursor-pointer transition-all duration-300 hover:bg-[var(--theme-hover)] group">
        <Image
          width={45}
          height={45}
